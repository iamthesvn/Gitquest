        ...
        chapters: vec![
            ...
            Chapter {
                ...
                npc_dialogue: &[
                    ...
                    "This is how blame wars start — nobody knows who did what, and Chacon will *absolutely* blame you for everything.",
    ...
    sandbox_verify: None,
            ...
            Chapter {
                ...
                npc_dialogue: &[
                    ...
                    "I've seen commit messages that say 'stuff' and 'asdfgh'. Chacon once wrote 'idk' on a Friday deploy. We do not do that here.",
...
fn volume_three() -> Volume {
        ...
        chapters: vec![
            ...
            Chapter {
                ...
                scene_art: &[
                    ...
                    "  ║  README.md                        ║",
                    "  ║  <<<<<<< HEAD                     ║",
                    "  ║  Preston's version of the intro    ║",
                    "  ║  =======                          ║",
                    "  ║  Chacon's version of the intro       ║",
                    "  ║  >>>>>>> origin/main              ║",
                    "  ╚════════════════════════════════════╝",
                ],
                npc_name: "Chacon",
                npc_dialogue: &[
                    ...
                    "Preston rewrote the whole README intro last night. I had already updated it this morning. Congrats, we have a conflict.",
    ...
    sandbox_verify: None,
            ...
            Chapter {
                ...
                npc_name: "Hyett",
                npc_dialogue: &[
                    "Good news: Chacon already wrote a clean fix for the auth issue on the dev branch.",
...
fn volume_four() -> Volume {
    Volume {
        ...
        chapters: vec![
            ...
            Chapter {
                ...
                npc_name: "Hyett",
                npc_dialogue: &[
                    "Alex? You're still here? It's past ten. Preston said you were 'just fixing a quick bug' three hours ago.",
    ...
    sandbox_verify: None,
            ...
            Chapter {
                ...
                npc_name: "Preston",
                npc_dialogue: &[
                    "So Wanstrath asked me to update the release notes for tomorrow's deploy. He wants to know EVERY file that changed.",
